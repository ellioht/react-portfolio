...
const Main = () => {
  const projects = [
    { id: 1, title: "Project 1", description: "Description for Project 1" },
    {
      ...
      imageUrl: `${process.env.PUBLIC_URL}/images/languageapp.png`,
      fontClr: "#fff",
    ...
    },
    {
      ...
      imageUrl: `${process.env.PUBLIC_URL}/images/typinggame.png`,
      fontClr: "#fff",
      linkToProject: true,
    ...
    },
    {
      ...
      imageUrl: `${process.env.PUBLIC_URL}/images/weatherapp.png`,
      fontClr: "#222",
      linkToProject: false,
    ...
    },
    {
      ...
      imageUrl: `${process.env.PUBLIC_URL}/images/oop-game.png`,
      fontClr: "#fff",
      linkToProject: true,
